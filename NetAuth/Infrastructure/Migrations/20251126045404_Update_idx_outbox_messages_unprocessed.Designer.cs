...
namespace NetAuth.Infrastructure.Migrations
{
    ...
    [Migration("20251126045404_Update_idx_outbox_messages_unprocessed")]
    partial class Update_idx_outbox_messages_unprocessed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NetAuth.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("OccurredOnUtc"), new[] { "Id", "Type", "Content", "AttemptCount" });
